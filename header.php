...
<meta name="p:domain_verify" content="83d4325860f5a2375b1cc99fcdb0e19a"/>
...
<div id="site">
	...
	<div id="nav-wrapper">
		...
		<div id="nav-inner">
			...
			<div id="mobi-nav">
				...
				<?php wp_nav_menu(array( 'theme_location' => 'main-menu', 'items_wrap' => '<select><option value="#">'.__('Inicio', 'mvp-text').'</option>%3$s</select>', 'walker' => new select_menu_walker() )); ?>
	...
	<div id="body-wrapper">
		...
		<div id="main-wrapper">
				...
				<?php } ?>
                <div id="leaderboard-wrapper" class="logo-header q2w3_inc_manager">

                <?php if ( (( is_home() || is_front_page() )) && method_exists('q2w3_inc_manager', 'manual_inc') ) q2w3_inc_manager::manual_inc(2); ?>
                <?php if ( is_category()  && method_exists('q2w3_inc_manager', 'manual_inc') ) q2w3_inc_manager::manual_inc(10); ?>
                <?php if ( is_single()  && method_exists('q2w3_inc_manager', 'manual_inc') ) q2w3_inc_manager::manual_inc(11); ?>
                </div>
				...
				<div id="leaderboard-wrapper" class="logo-leader">
					...
					<?php } ?>
                    <div id="leader-medium" class="q2w3_inc_manager">
                        <?php if ( (( is_home() || is_front_page() )) && method_exists('q2w3_inc_manager', 'manual_inc') ) q2w3_inc_manager::manual_inc(2); ?>
                        <?php if ( is_category()  && method_exists('q2w3_inc_manager', 'manual_inc') ) q2w3_inc_manager::manual_inc(10); ?>
                        <?php if ( is_single()  && method_exists('q2w3_inc_manager', 'manual_inc') ) q2w3_inc_manager::manual_inc(11); ?>
                    </div>
				...
				<div id="leaderboard-wrapper" class="logo-header">
                    ...
                    <div id="leader-large" class="q2w3_inc_manager">
                        <?php if ( (( is_home() || is_front_page() )) && method_exists('q2w3_inc_manager', 'manual_inc') ) q2w3_inc_manager::manual_inc(2); ?>
                        <?php if ( is_category()  && method_exists('q2w3_inc_manager', 'manual_inc') ) q2w3_inc_manager::manual_inc(10); ?>
                        <?php if ( is_single()  && method_exists('q2w3_inc_manager', 'manual_inc') ) q2w3_inc_manager::manual_inc(11); ?>
					<?php } ?></div>
