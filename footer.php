		<div id="footer-wrapper">
			<div id="footer-top">
                ...
                <?php } ?>
                    <?php if ( (( is_home() || is_front_page() )) && method_exists('q2w3_inc_manager', 'manual_inc') ) q2w3_inc_manager::manual_inc(3); ?>
                    <?php if ( is_category()  && method_exists('q2w3_inc_manager', 'manual_inc') ) q2w3_inc_manager::manual_inc(12); ?>
                    <?php if ( is_single()  && method_exists('q2w3_inc_manager', 'manual_inc') ) q2w3_inc_manager::manual_inc(13); ?>
				</div><!--footer-leaderboard-->
				<div id="footer-widget-wrapper">
					<?php $footer_info = get_option('mvp_footer_info'); if ($footer_info == "true") { ?>
					<div class="footer-widget">g
