	...
	<div id="content-wrapper">
		...
		<div id="content-main">
			...
			<div id="home-main">
				...
				<h1 class="home-widget-header"><?php single_cat_title(); ?></h1>
				...
				<div class="home-widget">
					...
					<ul class="wide-widget cat-home-widget infinite-content">
						...
						<?php $mvp_slider_cat = get_option('mvp_slider_cat'); if ($mvp_slider_cat == "true") { ?>
							...
							<?php if (isset($do_not_duplicate)) { $adtimelineindex=-1; $adcounter=-1;if (have_posts()) : while (have_posts()) : the_post(); if (in_array($post->ID, $do_not_duplicate)) continue; ?>
                                            <?php $adcounter=$adcounter+1 ;if($adcounter % 3 == 2) { $adtimelineindex=$adtimelineindex +1; ?>
                                            <li class="infinite-post-ad" stlye="">
                                                 <div class="ad_desktop ad_mobile" data-adunit="sl5_d_c_category_inline_300x250_85" data-dimensions="468x60,300x250,300x300,336x280" data-exclusions="adultcategory"></div>
                                            </li>
                                            <?php } ?>
						...
						<?php } else { ?>
							...
							<?php $adtimelineindex=-1; $adcounter=-1;if (have_posts()) : while (have_posts()) : the_post(); ?>
                                        <?php $adcounter=$adcounter+1 ;if($adcounter % 3 == 2) { $adtimelineindex=$adtimelineindex +1; ?>
                                        <li class="infinite-post-ad" stlye="">
                                             <div class="ad_desktop ad_mobile" data-adunit="sl5_d_c_category_inline_300x250_85" data-dimensions="468x60,300x250,300x300,336x280" data-exclusions="adultcategory"></div>
                                        </li>
